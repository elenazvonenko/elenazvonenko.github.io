$(function() {
    $('.main_item_wrap ul').after('<div class="main_item_wrap_after"></div>')
    $('.main_toggle').click(function(){
       
        
        if($(this).parent().parent().children('ul').is(':visible')){
            $(this).parent().parent().children('ul').slideUp(); $(this).parent().parent().children('.main_item_wrap_after').hide();
           
        }
        else{
             $('.main_item').removeClass('active')
        $(this).parent().addClass('active')
             $('.main_item_wrap ul, .main_item_wrap_after').hide();
            $(this).parent().parent().children('ul').slideDown(); $(this).parent().parent().children('.main_item_wrap_after').show(300);
        }
	...
	var eqElement = ".hi_item, .bottom_content div"
